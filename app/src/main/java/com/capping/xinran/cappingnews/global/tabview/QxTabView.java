 ...
 */
public class QxTabView extends HorizontalScrollView {
    ...
    public QxTabView(Context context) {
        this(context, null);
    }

    public QxTabView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public QxTabView(Context context, AttributeSet attrs, int defStyle) {
