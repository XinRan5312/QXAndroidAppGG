...
import com.capping.xinran.cappingnews.global.utils.cache.QSharedPreferences;
...
public class AppUtils {
    ...
    public static String Product_Name = "appName";
    ...
    public static String getCurrentNetType() {
        String type = "";
        ConnectivityManager cm = (ConnectivityManager) EngloryApplication.getAppContext()
                .getSystemService(Context.CONNECTIVITY_SERVICE);
        NetworkInfo info = cm.getActiveNetworkInfo();
        if (info == null) {
            type = NetworkState_Wifi;
    ...
    public static boolean isWifi() {
        ConnectivityManager connectivityManager = (ConnectivityManager) EngloryApplication.getAppContext()
                .getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static String getDeviceId() {
        ...
        if (ContextCompat.checkSelfPermission(EngloryApplication.getAppContext(), Manifest.permission.READ_PHONE_STATE) == PackageManager.PERMISSION_GRANTED) {
            TelephonyManager TelephonyMgr = (TelephonyManager) EngloryApplication.getAppContext()
                    .getSystemService(EngloryApplication.getAppContext().TELEPHONY_SERVICE);
            DeviceId = TelephonyMgr.getDeviceId();// Requires READ_PHONE_STATE
        } else {
            DeviceId = QSharedPreferences.newInstance(EngloryApplication.getAppContext(),"appShaedPreference","qx").getString(RANDOMUUID, "");
    ...
    public static String getUserAgnet() {
        ...
        WebView webview = new WebView(EngloryApplication.getAppContext());
    ...
    public static String genericDeviceId() {
        String Devicenum = QSharedPreferences.newInstance(EngloryApplication.getAppContext(),"appShaedPreference","qx").getString(RANDOMUUID, "");
        if (isStringNull(Devicenum)) {
            Devicenum = UUID.randomUUID().toString();
            QSharedPreferences.newInstance(EngloryApplication.getAppContext(),"appShaedPreference","qx").putString(RANDOMUUID, Devicenum);
        }
        return Devicenum;
    }
    ...
    public static boolean isNetEnable() {
        ConnectivityManager connectivity = (ConnectivityManager) EngloryApplication.getAppContext()
                .getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static String getVersionName() {
        try {
            PackageManager manager = EngloryApplication.getAppContext().getPackageManager();
            PackageInfo info = manager.getPackageInfo(
                    EngloryApplication.getAppContext().getPackageName(), 0);
