 ...
 */
public class FooterWidgitView extends View {
    ...
    public FooterWidgitView(Context context) {
        this(context, null);
    }

    public FooterWidgitView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FooterWidgitView(Context context, AttributeSet attrs, int defStyleAttr) {
