package com.capping.xinran.cappingnews.global.tabview;
 ...
 */
public abstract class QxBaseListViewContainer extends LinearLayout {
    ...
    public QxBaseListViewContainer(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public QxBaseListViewContainer(Context context) {
        super(context);
        init();
    }
...
//                mScrollStateListener.onScrollUp();
    ...
    public interface OnHeaderRefreshListener {
        void onHeaderRefresh(QxBaseListViewContainer view);
    }
