...
import com.capping.xinran.cappingnews.global.utils.QEncode;
...
/**
 * 1：扩展了系统自带的SharedPreferences本身的功能
 * 2：对保存数据进行了加密
...
public class QSharedPreferences implements IStorage{
    ...
    private boolean putBytes(int type,String key,byte[] value) {
        ...
        try {
            ...
            value = QEncode.encodeDES(data, dekey);
    ...
    private byte[] de(String value) {
        if(!TextUtils.isEmpty(value)) {
            ...
            data = QEncode.decodeDES(data,dekey);
            return data;
        }
        return null;
    }
