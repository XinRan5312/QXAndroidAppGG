package com.capping.xinran.cappingnews.global.tabview.downtap;
...
/**
 * A simple extension of a regular linear layout that supports the divider API of Android 4.0+. The dividers are added
 * adjacent to the children by changing their layout params. If you need to rely on the margins which fall in the same
 * orientation as the layout you should wrap the child in a simple {@link android.widget.FrameLayout} so it can receive
 * the margin.
 */
public class IcsLinearLayout extends LinearLayout {
     ...
     * 
     * @param showDividers One or more of {@link #SHOW_DIVIDER_BEGINNING}, {@link #SHOW_DIVIDER_MIDDLE}, or
     *            {@link #SHOW_DIVIDER_END}, or {@link #SHOW_DIVIDER_NONE} to show no dividers.
     */
    ...
    /**
     * When true, all children with a weight will be considered having the minimum size of the largest child. If false,
    ...
    /**
     * When set to true, all children with a weight will be considered having the minimum size of the largest child. If
     * false, all children are measured normally.
     * 
     * Disabled by default.
     * 
     * @param enabled True to measure children with a weight using the minimum size of the largest child, false
     *            otherwise.
     * 
     * @attr ref android.R.styleable#LinearLayout_measureWithLargestChild
     */
