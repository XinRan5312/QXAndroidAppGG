package com.capping.xinran.cappingnews.global.tabview.qrefreshview.widgit;
 ...
 */
public class HeaderWidgitView extends View {
    ...
    public HeaderWidgitView(Context context) {
        this(context, null);
    }

    public HeaderWidgitView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HeaderWidgitView(Context context, AttributeSet attrs, int defStyleAttr) {
